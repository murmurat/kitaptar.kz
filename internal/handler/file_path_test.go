...
func TestHandler_createFilePath(t *testing.T) {
	...
	for _, testCase := range testTable {
		t.Run(testCase.name, func(t *testing.T) {
			...
			request := httptest.NewRequest("POST", "/file_path/create", bytes.NewBufferString(testCase.inputBody))
...
func TestHandler_updateFilePath(t *testing.T) {
	...
	for _, testCase := range testTable {
		t.Run(testCase.name, func(t *testing.T) {
			...
			recorder := httptest.NewRecorder()
			request := httptest.NewRequest("PUT", fmt.Sprintf("/file_path/update/%s", testCase.inputFilePathID), bytes.NewBufferString(testCase.inputBody))
			request.Header.Set("Authorization", "Bearer token")
...
func TestHandler_getFilePathById(t *testing.T) {
	...
	for _, testCase := range testTable {
		t.Run(testCase.name, func(t *testing.T) {
			...
			recorder := httptest.NewRecorder()
			request := httptest.NewRequest("GET", strings.TrimSpace(fmt.Sprintf("/file_path/%s", testCase.inputID)), bytes.NewBufferString(testCase.inputID))
...
func TestHandler_deleteFilePath(t *testing.T) {
	...
	for _, testCase := range testTable {
		t.Run(testCase.name, func(t *testing.T) {
			...
			recorder := httptest.NewRecorder()
			request := httptest.NewRequest("DELETE", fmt.Sprintf("/file_path/delete/%s", testCase.inputID), bytes.NewBufferString(testCase.inputID))
			request.Header.Set("Authorization", "Bearer token")
...
func TestHandler_getAllFilePaths(t *testing.T) {
	...
	for _, testCase := range testTable {
		t.Run(testCase.name, func(t *testing.T) {
			...
			recorder := httptest.NewRecorder()
			request := httptest.NewRequest("GET", "/file_path/all", nil)
