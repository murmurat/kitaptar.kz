...
func TestHandler_createAuthor(t *testing.T) {
	...
	for _, testCase := range testTable {
		t.Run(testCase.name, func(t *testing.T) {
			...
			request := httptest.NewRequest("POST", "/author/create", bytes.NewBufferString(testCase.inputBody))
...
func TestHandler_updateAuthor(t *testing.T) {
	...
	for _, testCase := range testTable {
		t.Run(testCase.name, func(t *testing.T) {
			...
			recorder := httptest.NewRecorder()
			request := httptest.NewRequest("PUT", strings.TrimSpace(fmt.Sprintf("/author/update/%s", testCase.inputID)), bytes.NewBufferString(testCase.inputBody))
			request.Header.Set("Authorization", "Bearer token")
...
func TestHandler_getAuthorById(t *testing.T) {
	...
	for _, testCase := range testTable {
		t.Run(testCase.name, func(t *testing.T) {
			...
			recorder := httptest.NewRecorder()
			request := httptest.NewRequest("GET", strings.TrimSpace(fmt.Sprintf("/author/%s", testCase.authorID)), bytes.NewBufferString(testCase.authorID))
			request.Header.Set("Authorization", "Bearer token")
...
func TestHandler_deleteAuthor(t *testing.T) {
	...
	for _, testCase := range testTable {
		t.Run(testCase.name, func(t *testing.T) {
			...
			recorder := httptest.NewRecorder()
			request := httptest.NewRequest("DELETE", fmt.Sprintf("/author/delete/%s", testCase.inputID), bytes.NewBufferString(testCase.inputID))
			request.Header.Set("Authorization", "Bearer token")
...
func TestHandler_getAllAuthors(t *testing.T) {
	...
	for _, testCase := range testTable {
		t.Run(testCase.name, func(t *testing.T) {
			...
			recorder := httptest.NewRecorder()
			request := httptest.NewRequest("GET", "/author/all", nil)
